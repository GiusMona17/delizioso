# Graph Report - delizioso  (2026-08-14)
...
### Community 14 - "DeliziosoApplication.kt"
Cohesion: 0.19
...
- **Why does `RecipeWithDetails` connect `RecipeWithDetails` to `ClayComponents.kt`, `ImportViewModel.kt`, `Json`, `EditRecipeScreen.kt`, `clayBevel`, `RecipeRepository`, `RecipeDetailScreen.kt`, `UserPreferences`, `StructuredRecipe`, `GroceryViewModel.kt`?**
